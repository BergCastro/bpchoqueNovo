CREATE TABLE resultados_teste(
	...
	FOREIGN KEY (prova1) REFERENCES provas(id),
	FOREIGN KEY (prova2) REFERENCES provas(id),
	FOREIGN KEY (prova3) REFERENCES provas(id),
	FOREIGN KEY (prova4) REFERENCES provas(id),
	FOREIGN KEY (prova5) REFERENCES provas(id)
